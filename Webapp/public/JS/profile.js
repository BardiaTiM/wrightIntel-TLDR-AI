...
document.getElementById("edit-button").addEventListener("click", async (event) => {
  ...
  if (editButtonClicked) {
    ...
    profileImageTitle();
    listImages(["/images/profile_images/captain-gray.png", "/images/profile_images/pilot-black.png", "/images/profile_images/pilot-blue-circle.png"
      , "/images/profile_images/pilot-blue.png", "/images/profile_images/pilot-gray.png", "/images/profile_images/pilot-pink.png"
      , "/images/profile_images/pilot-white.png", "/images/profile_images/woman-blue.png"]);
    createSaveButton();
