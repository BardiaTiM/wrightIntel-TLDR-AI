...
for i in range(3):
    if i == 0:
        # copy and paste is needed
        get_html('//a[@href="/en-ca/interruptions/eu-alternate-dispute"]', '//div[@class="com-collapsible-content__content"]')
    elif i == 1:
        get_html('//a[@href="/en-ca/interruptions/mexico"]', '//div[@class="com-container__content"]')
    elif i == 2:
        # copy and paste is needed
