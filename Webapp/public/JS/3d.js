...
renderer.domElement.classList.add("globe-container");
...
(async function () {
  ...
  const ring1 = new Mesh(
    new RingGeometry(7.5, 6.75, 80, 1, 0),
    new MeshPhysicalMaterial({
  ...
  const ring2 = new Mesh(
    new RingGeometry(8.25, 7.875, 80, 1, 0), 
